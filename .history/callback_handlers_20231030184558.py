...
from db_operations import (get_family_members, 
                           ...
                           add_reminder,
                           add_family_member)
from db_operations import add_family_member, get_family_member_by_name, get_family_members
...
def get_user_by_invite_id(user_code):
    ...
    return get_family_member_by_name(user_code)
...
def user_exists_in_db(user_code, chat_id):
    ...
    """
    member = get_family_member_by_name(user_code)
