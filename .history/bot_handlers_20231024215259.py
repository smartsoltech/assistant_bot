...
def handle_callback_query(call):
    ...
    if command == 'add_event':
        ...
        bot.send_message(call.message.chat.id, "Пожалуйста, отправьте дату и описание напоминания в формате YYYY-MM-DD Описание", reply_markup=DetailedTelegramCalendar.)
